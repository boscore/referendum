...
先创建账户escrow.bos，然后部署合约，然后设置权限

先创建账户auditor.bos，然后部署合约，然后设置权限

先创建账户eosio.forum，然后部署合约，然后设置权限
...
### 6.1 分配 active权限到eosio\bet.bos\auditor.bos\当选的auditor
...
### 7.1 分配 active权限到escrow.bos\bet.bos\eosio 
